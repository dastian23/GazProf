...
class AdminPasswordConfirmScreen extends StatefulWidget {
  final String email;
  const AdminPasswordConfirmScreen({super.key, required this.email});

  @override
  State<AdminPasswordConfirmScreen> createState() => _AdminPasswordConfirmScreenState();
}

class _AdminPasswordConfirmScreenState extends State<AdminPasswordConfirmScreen> {
