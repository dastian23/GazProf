...
class SoferIstoricList extends StatelessWidget {
  ...
  const SoferIstoricList({super.key, required this.comenzi});
        ...
        return Padding(
          ...
          child: Row(
            children: [
              ...
              Text("tine ($displayName)", style: TextStyle(color: theme.textPrimary, fontSize: 12, fontWeight: FontWeight.bold)),
            ],
          ),
        );
      },
