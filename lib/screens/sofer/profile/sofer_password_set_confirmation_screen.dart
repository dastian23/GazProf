...
class SoferPasswordConfirmScreen extends StatefulWidget {
  final String email;
  const SoferPasswordConfirmScreen({super.key, required this.email});

  @override
  State<SoferPasswordConfirmScreen> createState() => _SoferPasswordConfirmScreenState();
}

class _SoferPasswordConfirmScreenState extends State<SoferPasswordConfirmScreen> {
