...
class SoferHomeScreen extends StatelessWidget {
                ...
                Expanded(
                  child: Padding(
                    ...
                    child: Column(
                      ...
                      children: [
                        Icon(Icons.directions_car_filled_outlined, size: 60, color: theme.brandBlue),
                        ...
                        Text(
                          "Momentan nu ai nicio cursă activă.\nVerifică secțiunea documente pentru a te asigura că totul este în regulă.",
