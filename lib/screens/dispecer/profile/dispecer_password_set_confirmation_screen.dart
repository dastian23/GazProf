...
class DispecerPasswordConfirmScreen extends StatefulWidget {
  final String email;
  const DispecerPasswordConfirmScreen({super.key, required this.email});

  @override
  State<DispecerPasswordConfirmScreen> createState() => _DispecerPasswordConfirmScreenState();
}

class _DispecerPasswordConfirmScreenState extends State<DispecerPasswordConfirmScreen> {
